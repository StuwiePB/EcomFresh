...
<body class="bg-gray-200 min-h-screen flex flex-col">
    ...
    <div class="w-full max-w-3xl">
      <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-2">
          ...
          <a id="newButton" href="{{ route('admin.vegetable.create') }}" class="bg-blue-700 text-white px-4 py-2 rounded hover:bg-blue-800 transition">New</a>
        </div>
      </div>
          ...
          <div class="bg-white rounded-xl shadow p-4 flex items-center justify-between">
            <div class="flex items-center gap-4">
              ...
              <div class="flex flex-col space-y-1">
                ...
                @php $lowestPrice = $vegetable->stores->min('pivot.current_price') ?? 0; @endphp
                <div class="flex flex-col space-y-1">
  ...
  <!-- Floating Button -->
  <a href="{{ route('admin.vegetable.create') }}" class="fixed bottom-6 right-6 bg-blue-700 text-white p-4 rounded-full shadow-lg hover:bg-blue-800 transition">
    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
