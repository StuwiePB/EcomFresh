...
use App\Models\Beef;
use App\Models\DeleteHistoryTable; // ✅ added for logging
...
class BeefController extends Controller
{
    ...
    /**
     * Delete beef (with delete history)
     */
    public function destroy($id)
    {
        $beef = Beef::findOrFail($id);

        // ✅ Log deletion into DeleteHistory table
        ...
        // ✅ Then soft-delete or permanently delete the item
        $beef->delete();

        return redirect()->route('admin.beef-crud')->with('success', 'Beef deleted and logged successfully!');
    }
